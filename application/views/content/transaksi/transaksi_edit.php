...
<!-- Default box -->
      <div class="box">
        ...
        <div class="box-body">
          <form action="<?php echo base_url('transaksi/update'); ?>" id="form" class="form-horizontal" enctype="multipart/form-data" method="POST" style ="padding: 30px 50px;">
            <input type="hidden" name="id" value="<?php echo $transaksi->transaksi_id; ?>">
                    ...
                    <div class="form-group">
                       <input type="text" name="pembeli" class="form-control" value="<?php echo $transaksi->transaksi_pembeli; ?>">
                    </div>
